  ...
  group('cache now playing movies', () {
    test('should call database helper to save data', () async {
      ...
      verify(mockDatabaseHelper
          .insertCacheNowPlayingMovies([testMovieCache], 'now playing'));
    });

    test('should return list of movies from db when data exist', () async {
      when(mockDatabaseHelper.getCacheNowPlayingMovies('now playing'))
          .thenAnswer((_) async => [testMovieCacheMap]);

      final result = await dataSource.getCacheNowPlayingMovies();
    ...
    test('should throw CacheException when cache data is not exist', () async {
      ...
      when(mockDatabaseHelper.getCacheNowPlayingMovies('now playing'))
          .thenAnswer((_) async => []);
      // act
      final call = dataSource.getCacheNowPlayingMovies();
      // assert
