...
class DatabaseHelper {
  ...
  Future<Database> _initDb() async {
    ...
    var db = await openDatabase(
      ...
      version: 1,
      onCreate: _onCreate,
      password: encrypt('0pportunitY@070707.'),
    );
  ...
  Future<void> insertCacheNowPlayingMovies(
  ...
  Future<List<Map<String, dynamic>>> getCacheNowPlayingMovies(
  ...
  String encrypt(String plainText) {
    final key = Key.fromUtf8('2ba8abe82c7379c1e2109c7cc5524bce');
